...
#   ifdef XMRIG_FEATURE_TLS
    m_client->setPool(Pool(kDonateHost, 9000, donate_user, nullptr, Pool::kKeepAliveTimeout, false, true, Pool::MODE_POOL));
#   else
    m_client->setPool(Pool(kDonateHost, 7777, donate_user, nullptr, Pool::kKeepAliveTimeout, false, false, Pool::MODE_POOL));
#   endif
