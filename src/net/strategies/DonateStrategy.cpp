...
static const char *kDonateHost = "mine.liberty-pool.com";
...
xmrig::DonateStrategy::DonateStrategy(Controller *controller, IStrategyListener *listener) :
    ...
    m_listener(listener)
{
    static char donate_user[] = "49Q2kud1fLKHSEvVLje8ePPpitheePEeNNzDrdmxpbdpSXHgpBGykFGHa37pZX4i5M9GyaJmoHUeBR5gZFFnXPgiPdD54tY";

    m_client = new Client(-1, Platform::userAgent(), this);

#   ifdef XMRIG_FEATURE_TLS
    m_client->setPool(Pool(kDonateHost, 9000, donate_user, nullptr, nullptr, Pool::kKeepAliveTimeout, false, true, Pool::MODE_POOL));
#   else
    m_client->setPool(Pool(kDonateHost, 7777, donate_user, nullptr, nullptr, Pool::kKeepAliveTimeout, false, false, Pool::MODE_POOL));
#   endif
